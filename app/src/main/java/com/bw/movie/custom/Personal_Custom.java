...
public class Personal_Custom extends ScrollView {
    ...
    public Personal_Custom(Context context) {
        super(context);
    }

    public Personal_Custom(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public Personal_Custom(Context context, AttributeSet attrs, int defStyleAttr) {
